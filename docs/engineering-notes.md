...
| 구분 | 구현·기여 |
| --- | --- |
| 공세민 | U2D2·SDK 통신 환경, 7개 모터 스캔, 단일·키보드·원위치·정지 도구, 아크릴 고정부 제작, 스풀·텐던 기구 통합 |
| 팀 | MediaPipe 인식, 7축 목표 계산, ROS 2 명령 중재·guard·안전 상태, 운영 모터 드라이버, 관제·기록·업로드 |
| 팀 시연 | 손동작 모방, 순차 손가락 동작, 캔·유연 물체 파지 |

개인 작업은 [7월 28일 제어 일지](daily-reports/2026-07-28/2026-07-28-공세민.md),
