...
공세민은 **Blender 모델링·3D 프린팅, U2D2 통신·7개 모터 동기 구동·키보드 제어, ROS 브릿지와 Cyclone DDS 통신 설정, 고정부·스풀·텐던 통합**을 담당했습니다. 손동작 인식, 명령 중재·guard·안전 상태, 관제 UI·기록 등은 팀 구현입니다. 아래 표는 그중 공개된 모터 점검 코드의 세부 처리입니다.
